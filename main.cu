...
int initRender(string configPath, int renderNumber)
{
    ...
    std::string filename = config.name + ".bmp";
...
int main ()
{
    ...
    //Camera camera = Camera::Pinhole(f4(0.0f,-0.6f, 1.0f), w, h, 25.0f, 0.0f, 0.0f, 60.0f);
    Camera camera = Camera::Pinhole(f4(0.0f,0.0f, 1.0f), w, h, 0.0f, 0.0f, 0.0f, 50.0f);
    ...
    //readObjSimple("scenedata/mothguy2.obj", points, normals, colors, uvs, mesh, lightsvec, f4(0.9f,0.9f,0.9f), f4(), 4);
    ...
    readObjSimple("scenedata/waterCaustic2.obj", points, normals, colors, uvs, mesh, lightsvec, 1.0f*f4(0.9f,0.4f,0.4f), f4(), 10);
    //readObjSimple("scenedata/diamond.obj", points, normals, colors, uvs, mesh, lightsvec, 1.0f*f4(0.9f,0.4f,0.4f), f4(), 18);
    ...
    readObjSimple("scenedata/smallwaterlight5.obj", points, normals, colors, uvs, mesh, lightsvec, 1.0f*f4(1.0f,1.0f,1.0f), 60.0f*f4(8.0f,8.0f,8.0f), 2);
